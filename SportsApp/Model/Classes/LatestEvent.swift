...
class LatestEvents : Decodable {
    ...
    required init(from decoder: Decoder) throws {
     ...
     /*   if self.home_team_logo == nil {
            self.home_team_logo = try container.decodeIfPresent(String.self, forKey: .event_home_team_logo)
              }
        if self.away_team_logo == nil {
            self.away_team_logo = try container.decodeIfPresent(String.self, forKey: .event_away_team_logo)
              }*/
